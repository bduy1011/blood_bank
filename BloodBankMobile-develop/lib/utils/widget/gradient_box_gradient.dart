...
class GradientShadowBoxDecoration extends Decoration {
  ...
  static GradientShadowBoxDecoration? lerp(GradientShadowBoxDecoration? a,
      GradientShadowBoxDecoration? b, double t) {
...
class _BoxDecorationPainter extends BoxPainter {
  ...
  void _paintShadows(Canvas canvas, Rect rect, TextDirection? textDirection) {
    if (_decoration.boxShadow == null) {
      const boxShadow =
          BoxShadow(blurRadius: 15, spreadRadius: 2, color: Colors.black);
